...
async function run() {
  ...
  console.log('\n' + line);
  console.log(`  jabearri v${VERSION} — authorization regression testing`);
  ...
  console.log(`  ✓  jabearri proxy     http://127.0.0.1:${PROXY_PORT}\n`);
  ...
  saveReport(findings, store, 'jabearri-demo-report.json');
  ...
  if (findings.length === 0) {
    ...
    console.log(`  Full report saved to jabearri-demo-report.json`);
  }
  console.log(line + '\n');
